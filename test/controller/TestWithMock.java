...
public class TestWithMock {
  ...
  public void testAddPlayerWithMock() {
    ...
    assertEquals(
        "Input: Character name: p1, Current room: Armory, items: [], player type: human 0\n"
            ...
            + "Input: Character name: p3, Current room: Billiard Room, items: [], player type: human 1\n",
        log.toString());
  }
  ...
  public void testComputerCommandWithMock() {
    ...
    assertEquals(
        "Input: Character name: p1, Current room: Armory, items: [], player type: human 0\n"
            + "Input: Character name: p2, Current room: Billiard Room, items: [], player type: human 1\n"
            + "Input: Character name: p3, Current room: Carriage House, items: [], player type: human 2\n"
            + "Input: Character name: p4, Current room: Drawing Room, items: [], player type: human 4\n"
            + "Input: Character name: p1, Current room: Armory, items: [Revolver], player type: computer\n"
            + "Input: Character name: p2, Current room: Billiard Room, items: [Billiard Cue], player type: computer\n"
            + "Input: Character name: p3, Current room: Winter Garden, items: [], player type: computer\n"
            + "Input: Character name: p4, Current room: Wine Cellar, items: [], player type: computer\n"
            + "Input: Character name: p1, Current room: Armory, items: [Revolver], player type: computer\n"
            + "Input: Character name: p1, Current room: Armory, items: [Revolver], player type: computer\n",
        log.toString());
  }
  ...
  public void testMoveToNeighbourWithMock() {
    ...
    c.playGame(gamingModel);
    assertEquals(
        "Input: Character name: p1, Current room: Dining Hall, items: [], player type: human 3\n"
            + "Input: Character name: p1, Current room: Tennessee Room, items: [], player type: human 0 0\n",
        log.toString());
  }
  ...
  public void testPickItemWithMock() {
    ...
    assertEquals(
        "Input: Character name: p1, Current room: Armory, items: [], player type: human 0\n"
            + "Input: Character name: p1, Current room: Armory, items: [Revolver], player type: human 0\n",
        log.toString());
  }
  ...
  public void testLookAroundWithMock() {
    ...
    assertEquals(
        "Input: Character name: p1, Current room: Armory, items: [], player type: human 0\n"
            + "Input: Character name: p2, Current room: Billiard Room, items: [], player type: human 1\n"
            + "Input: Character name: p3, Current room: Library, items: [], player type: human 10\n"
            + "Input: Character name: p1, Current room: Armory, items: [], player type: human\n"
            + "Input: Character name: p2, Current room: Billiard Room, items: [], player type: human\n"
            + "Input: Character name: p3, Current room: Library, items: [], player type: computer\n"
            + "Input: Character name: p3, Current room: Library, items: [], player type: computer\n"
            + "Input: Character name: p1, Current room: Armory, items: [], player type: human\n",
        log.toString());
    assertEquals("Welcome to the kill doctor lucky game\n" + "The rooms are initialized as:\n"
        ...
        + "visibleRooms = [Dining Hall, Tennessee Room, Lilac Room, Master Suite, Armory, Foyer, Piazza, Wine Cellar, ]\n"
        + "\n" + "SpecifiedRoom{name='Foyer', index=5, \n"
        + "leftCorner=13, rightCorner=18, upperCorner=26, lowerCorner=27, \n"
        + "items in the room =[], \n" + "characters=[]}, \n"
        + "neighbours = [Drawing Room, ][][Piazza, ][], \n"
        + "visibleRooms = [Drawing Room, Dining Hall, Tennessee Room, Lilac Room, Master Suite, Piazza, ]\n"
        ...
        + "visibleRooms = [Parlor, Servants' Quarters, Lancaster Room, Dining Hall, Billiard Room, Trophy Room, Wine Cellar, ]\n"
        ...
        + "visibleRooms = [Lilac Room, Master Suite, Library, Nursery, Servants' Quarters, Parlor, Kitchen, Wine Cellar, ]\n"
        ...
        + "visibleRooms = [Nursery, Trophy Room, Billiard Room, Armory, Master Suite, Lilac Room, Lancaster Room, Servants' Quarters, ]\n"
        ...
        + "visibleRooms = [Master Suite, Library, Nursery, Tennessee Room, Dining Hall, Armory, Wine Cellar, Drawing Room, Foyer, Piazza, Lancaster Room, Servants' Quarters, ]\n"
        ...
        + "visibleRooms = [Library, Nursery, Tennessee Room, Dining Hall, Armory, Wine Cellar, Drawing Room, Foyer, Piazza, Lilac Room, Lancaster Room, Servants' Quarters, ]\n"
        ...
        + "visibleRooms = [Library, Trophy Room, Billiard Room, Armory, Master Suite, Lilac Room, Lancaster Room, Servants' Quarters, ]\n"
        ...
        + "visibleRooms = [Foyer, Drawing Room, Dining Hall, Tennessee Room, Lilac Room, Master Suite, Hedge Maze, Green House, Winter Garden, Carriage House, ]\n"
        ...
        + "visibleRooms = [Lancaster Room, Lilac Room, Master Suite, Library, Nursery, Parlor, Kitchen, Wine Cellar, ]\n"
        ...
        + "visibleRooms = [Library, Nursery, Billiard Room, Armory, Dining Hall, Tennessee Room, Parlor, Parlor, Kitchen, ]\n"
        ...
        + "visibleRooms = [Dining Hall, Kitchen, Parlor, Servants' Quarters, Lancaster Room, Tennessee Room, Lilac Room, Master Suite, Drawing Room, Armory, ]\n"
        ...
        + "leftCorner=21, rightCorner=28, upperCorner=16, lowerCorner=21, \n"
        + "items in the room =[Billiard Cue], \n"
        + "characters=[Character name: p2, Current room: Billiard Room, items: [], player type: human]}, \n"
        + "neighbours = [Trophy Room, ][][Armory, ][Dining Hall, ], \n"
        + "visibleRooms = [Trophy Room, Library, Nursery, Armory, Dining Hall, Parlor, Kitchen, ]\n"
        + "---------------------------------\n"
        + "Enter 1 to move to neighbour. Then enter the direction and index of the neighbour\n"
