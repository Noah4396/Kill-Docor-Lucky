...
public class GamingConsoleControllerTest {
  ...
  public void testInvalidMove() {
    ...
    c.playGame(gamingModel);
    expectOutput.append(
        "Enter 1 to add a player; Enter 2 to add a computer playe"
  ...
  public void testPickItem() {
    ...
    c.playGame(gamingModel);
    expectOutput.append(
        "Enter 1 to add a player; Enter 2 to add a computer player; Enter 3 "
  ...
  public void testPickInvalidItem() {
    ...
    c.playGame(gamingModel);
    expectOutput.append(
        "Enter 1 to add a player; Enter 2 to add a computer player; E"
